...
class EvidencePipeline:
    ...
    def _is_scientific_post_content(
        ...
        prompt = (
            "Фильтр: научный ли это контент? Отвечай JSON: {\"scientific\": true|false}.\n\n"
            "Включить ТОЛЬКО если пост: разбирает исследование, механизмы, данные; "
            "цитирует или обсуждает литературу; даёт научно обоснованный вывод.\n\n"
            "Исключить (scientific=false): "
            "мотивационные посты («люби цели», «расти через вызов», «духовный поиск»); "
            "поздравления и личные обновления; отчёты о соревнованиях, забегах; "
            "реклама коучинга/тренера; «с началом весны», атлет на велосипеде без анализа; "
            "жизненные советы без ссылок на исследования. "
            "Если упоминаются goals, training, growth, но нет науки — это false."
        )
        payload = {
